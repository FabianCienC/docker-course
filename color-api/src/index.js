...
const fail_liveness = process.env.DELAY_LIVENESS === "true";
const fail_readiness = process.env.DELAY_READINESS === "true" ? Math.random() < 0.5 : false;
...
app.listen(port, () => {
    console.log("Color api listen in port 80")
});